...
export default function Dashboard() {
  ...
  if (loading) {
    return <div className="dashboard" style={{padding:'2rem', textAlign:'center'}}>Loading Dashboard...</div>;
  }
  ...
  return (
    <div className="dashboard">
      ...
      <div className="dashboard-card dashboard-card-large">
        ...
        <p className="dashboard-card-subtitle">Calculated based on (Cost × Quantity) of all products</p>
      </div>
        ...
        <div className="dashboard-card chart-card">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={chartData}>
              ...
              />
              <Bar dataKey="value" fill="#3b82f6" radius={[4, 4, 0, 0]} name="Stock Quantity">
