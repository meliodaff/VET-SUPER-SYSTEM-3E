...
<head>
    ...
    <title>My Active Vouchers - FUR-EVER CARE</title>
...
<body>
    ...
    <div class="tabs-container">
        <div class="tabs">
            ...
            <a href="vouchers.php" class="tab active">Vouchers</a>
        </div>
    </div>

    <div class="vouchers-container">
        <h1>My Active Vouchers</h1>
        <p class="subtitle">Your personal discount codes are ready to use.</p>

        <div class="vouchers-grid">
            <!-- Welcome Voucher -->
            <div class="voucher-card">
                <div class="voucher-header welcome">
                    <span class="voucher-type">Welcome</span>
                </div>
                <div class="voucher-content">
                    <div class="discount">25% OFF</div>
                    <p class="description">Welcome discount for new customers</p>

                    <div class="voucher-code-section">
                        <p class="code-label">Voucher Code</p>
                        <div class="code-container">
                            <span class="code">WELCOME25</span>
                    ...
                    <div class="voucher-details">
                        <div class="detail-item">
                            <span class="label">Minimum Spend:</span>
                            <span class="value">₱500</span>
                        </div>
                        <div class="detail-item">
                            <span class="label">Expires:</span>
                            <span class="value">12/31/25</span>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Loyalty Voucher -->
            <div class="voucher-card">
                <div class="voucher-header loyalty">
                    <span class="voucher-type">Loyalty</span>
                </div>
                <div class="voucher-content">
                    <div class="discount">15% OFF</div>
                    <p class="description">Special discount for loyal customers</p>

                    <div class="voucher-code-section">
                        <p class="code-label">Voucher Code</p>
                        <div class="code-container">
                            <span class="code">LOYAL15</span>
                            <button class="copy-btn" onclick="copyCode(this)">Copy Code</button>
                        </div>
                    </div>
                    ...
                    <div class="voucher-details">
                        ...
                        <div class="detail-item">
                            <span class="label">Expires:</span>
                            <span class="value">06/30/24</span>
                        </div>
                    </div>
                </div>
            </div>
