<?php
// Include config first (it handles session_start)
        ...
        <section class="hero" id="home">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <button class="get-started">Book Now</button>
                    <button class="learn-more">Learn More</button>
                </div>
            </div>
            <div class="hero-image">
                <div class="image-slider">
                    <img class="slide active" src="image/Doggo1.png" alt="Dog" />
                    <img class="slide" src="image/catto00.jpeg" alt="Cat 1">
                    <img class="slide" src="image/doggo01.jpeg" alt="Dog 2">
                    <img class="slide" src="image/puffcatto.jpeg" alt="Fluffy Cat">
                    <img class="slide" src="image/catto01.jpeg" alt="Cat 2">
                </div>
                ...
                <div class="services-grid">
                    <div class="service-card">
                        <div class="service-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M12 2a9 9 0 0 1 9 9c0 3.6-3.6 9-9 9s-9-5.4-9-9a9 9 0 0 1 9-9zM12 16v.01" />
                                <path d="M12 12l.01-.01" />
                            </svg>
                        </div>
                        <h3>General Checkups</h3>
                        <p>Comprehensive health examinations to keep your pets healthy and happy.</p>
                        <p class="service-details">Physical examination, Health assessment, and Preventive care
                            recommendations</p>
                    </div>
                    ...
                    <div class="service-card">
                        <div class="service-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2">
                                <path
                                    d="M19 2H5a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zM8 12h8M8 16h8M8 8h8" />
                            </svg>
                        </div>
                        <h3>Vaccinations</h3>
                        <p>Complete vaccination programs to protect your pets from diseases.</p>
                        <p class="service-details">Core vaccines, Non-core vaccines, Vaccination schedules, and health
                            certificates</p>
                    </div>
                    ...
                    <div class="service-card">
                        <div class="service-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2">
                                <path d="M12 2l9 4v6c0 5.25-7.2 9-9 9s-9-3.75-9-9V6l9-4z" />
                                <path d="M12 7v5" />
                                <path d="M12 15h.01" />
                            </svg>
                        </div>
                        ...
                        <p class="service-details">Emergency surgery, Critical care, Trauma treatment, and 24/7
                            availability</p>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <p class="service-details">Spay/neuter surgery, Orthopedic surgery, Soft tissue surgery, and
                            Dental surgery</p>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <p class="service-details">Parasite prevention, Dental care, Nutritional counseling, and Senior
                            pet care</p>
                    </div>
                    ...
                    <div class="service-card">
                        ...
                        <p class="service-details">Puppy/kitten programs, Senior pet care, Weight management, and
                            Behavioral counseling</p>
                    </div>
                </div>
            </div>
        </section>
