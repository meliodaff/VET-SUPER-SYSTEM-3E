-- ============================================
-- Fur-Ever Care Database - Fresh Install
-- Use this file if you have tablespace errors
-- ============================================

-- Create database
CREATE DATABASE IF NOT EXISTS fur_ever_care_db CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
(1, 2, 'INV-2024-001', '2024-01-15', '2024-01-30', 1300.00, 'paid'),
(2, 3, 'INV-2024-002', '2024-01-16', '2024-01-31', 1200.00, 'paid'),
(3, 2, 'INV-2024-003', '2024-01-17', '2024-02-01', 500.00, 'pending'),
(4, 3, 'INV-2024-004', '2024-01-18', '2024-02-02', 5000.00, 'paid'),
(5, 2, 'INV-2024-005', '2024-01-19', '2024-02-03', 1500.00, 'overdue'),
(6, 3, 'INV-2024-006', '2024-01-20', '2024-02-04', 800.00, 'paid'),
(7, 2, 'INV-2024-007', '2024-01-21', '2024-02-05', 600.00, 'pending'),
(8, 3, 'INV-2024-008', '2024-01-22', '2024-02-06', 5000.00, 'paid'), -- Updated: 3000 + 2000 (surgery)
(9, 2, 'INV-2024-009', '2024-01-23', '2024-02-07', 500.00, 'paid'),
(10, 3, 'INV-2024-010', '2024-01-24', '2024-02-08', 800.00, 'pending');

-- ============================================
-- Sample Data - Invoice Items
-- Includes surgery items for doctor surgery fees chart
-- ============================================
...
(3, 1, 1, 500.00, 500.00),
(4, 4, 1, 5000.00, 5000.00), -- Surgery (paid invoice)
(5, 5, 1, 1500.00, 1500.00),
(6, 6, 1, 800.00, 800.00),
(7, 7, 1, 600.00, 600.00),
(8, 8, 1, 3000.00, 3000.00),
(8, 4, 1, 2000.00, 2000.00), -- Additional Surgery (paid invoice)
(9, 1, 1, 500.00, 500.00),
(10, 2, 1, 800.00, 800.00);

-- ============================================
-- Sample Data - Payments (Philippine Context)
-- Updated with recent dates for sales trend (last 6 months)
-- Note: Dates are relative - update them to current dates when importing
-- ============================================
INSERT INTO payments (invoice_id, amount, payment_date, payment_method, reference_number) VALUES
(1, 1300.00, DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 5 MONTH), '%Y-%m-%d'), 'cash', 'CASH-2024-001'),
(2, 1200.00, DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 4 MONTH), '%Y-%m-%d'), 'cash', 'CASH-2024-002'),
(4, 5000.00, DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 3 MONTH), '%Y-%m-%d'), 'transfer', 'GCASH-2024-004'),
(5, 1500.00, DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 2 MONTH), '%Y-%m-%d'), 'debit_card', 'DC-2024-005'),
(6, 800.00, DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 1 MONTH), '%Y-%m-%d'), 'cash', 'CASH-2024-006'),
(7, 600.00, DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 3 WEEK), '%Y-%m-%d'), 'transfer', 'PAYMaya-2024-007'),
(8, 3000.00, DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 2 WEEK), '%Y-%m-%d'), 'transfer', 'BANK-TRF-2024-008'),
(9, 500.00, DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 1 WEEK), '%Y-%m-%d'), 'cash', 'CASH-2024-009');
