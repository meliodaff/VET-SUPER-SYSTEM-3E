...
<body>
  ...
  <main class="appointments-section">
    ...
    <div class="tabs">
      ...
      <a href="reject.php" class="tab active" data-tab="rejected">Rejected</a>
    ...
    $query = "SELECT * FROM book_appointment WHERE status = 'rejected' ORDER BY date DESC, time ASC";
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<h3 class="empty-title">No Approved Appointments</h3>';
    }
    ?>
  </div>
</div>
