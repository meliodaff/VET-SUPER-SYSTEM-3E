...
<body>
  ...
  <main class="appointments-section">
    <h2 class="appointments-title">Pending</h2>

    <!-- Tabs -->
   <div class="tabs">
    <a href="overview.php" class="tab">Overview</a>
    <a href="pending.php" class="tab active">Pending</a>
    ...
    <div class="" id="pending">
      <div class="appointments-table">
        ...
        $query = "SELECT * FROM book_appointment WHERE status = 'pending' ORDER BY date DESC, time ASC";
